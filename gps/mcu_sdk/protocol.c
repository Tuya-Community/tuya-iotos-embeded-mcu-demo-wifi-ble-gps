...
{
  {DPID_LATITUDE, DP_TYPE_STRING},
  {DPID_LONGITUDE, DP_TYPE_STRING},
};
...
void all_data_update(void)
{
    ...
    mcu_dp_string_update(DPID_LATITUDE,当前GPS纬度指针,当前GPS纬度数据长度); //STRING型数据上报;
    mcu_dp_string_update(DPID_LONGITUDE,当前GPS经度指针,当前GPS经度数据长度); //STRING型数据上报;
